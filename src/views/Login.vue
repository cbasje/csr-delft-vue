      ...
      <div class="container">
        ...
        <form @submit="login" method="post">
          ...
          <div class="form-group">
            ...
            <div v-for="error of v$.username.$errors" class="errors" :key="error.$uid">
            ...
            <div v-for="error of v$.password.$errors" class="errors" :key="error.$uid">
              <span class="error-msg">{{ error.$message }}</span>
            </div>
          </div>

          <ion-button type="submit" expand="block">Inloggen</ion-button>
        </form>
...
<script lang="ts">
import { IonPage, IonHeader, IonToolbar, IonTitle, IonContent, IonItem, IonLabel, IonButton, IonInput } from '@ionic/vue';
...
export default defineComponent({
  ...
  validations () {
    return {
      ...
      password: {
        required: helpers.withMessage('Wachtwoord is vereisd', required),
        $autoDirty: true
      },
    }
  }
